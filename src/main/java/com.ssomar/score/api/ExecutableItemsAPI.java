...
import com.ssomar.testRecode.executableItems.NewExecutableItem;
import com.ssomar.testRecode.executableItems.NewExecutableItemObject;
...
public class ExecutableItemsAPI {
    ...
    public static Optional<String> getExecutableItemId(ItemStack itemStack) {
        NewExecutableItemObject ei = new NewExecutableItemObject(itemStack);
        if (ei.isValid()) {
    ...
    public static List<String> getExecutableItemIdsList() {
        ...
        for (NewExecutableItem item : NewExecutableItemsManager.getInstance().getLoadedObjects()) {
            list.add(item.getId());
        }
        return list;
    }

...
public class ProjectilesLoader {
    ...
    public List<String> getProjectilesOfDefaultObjectsName() {
        ...
        defaultProjectiles.add("DEFAULT_INVISIBLE_ARROW");
        defaultProjectiles.add("DEFAULT_INVISIBLE_ARROW_NO_GRAVITY");
        defaultProjectiles.add("DEFAULT_INVISIBLE_ARROW_NO_GRAVITY_SPEED");
        ...
        defaultProjectiles.add("PACK_2_06");
        defaultProjectiles.add("PACK_2_12");

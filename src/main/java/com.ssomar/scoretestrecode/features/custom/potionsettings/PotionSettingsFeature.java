...
public class PotionSettingsFeature extends FeatureWithHisOwnEditor<PotionSettingsFeature, PotionSettingsFeature, PotionSettingsFeatureEditor, PotionSettingsFeatureEditorManager> {
    ...
    public PotionSettingsFeature initItemParentEditor(GUI gui, int slot) {
        ...
        if(SCore.is1v11Less()) finalDescription[finalDescription.length - 5] = "&7Potion color : &c&lNot for 1.11 or lower";
        ...
        if(SCore.is1v11Less()) finalDescription[finalDescription.length - 4] = "&7Potion type : &c&lNot for 1.11 or lower";
        else finalDescription[finalDescription.length - 4] = "&7Potion type : &e" + potiontype.getValue().get();

        if(SCore.is1v11Less()) finalDescription[finalDescription.length - 3] = "&7Potion extended : &c&lNot for 1.11 or lower";
        ...
        if(SCore.is1v11Less()) finalDescription[finalDescription.length - 2] = "&7Potion upgraded : &c&lNot for 1.11 or lower";

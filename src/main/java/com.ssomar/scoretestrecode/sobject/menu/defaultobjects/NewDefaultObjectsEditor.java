...
public class NewDefaultObjectsEditor extends GUI {

    @Getter
    @Setter
    private static int index;
    private static final int SOBJECT_PER_PAGE = 27;
    private NewSObjectManager<NewSObject> manager;
    private NewSObjectLoader loader;
    private SPlugin sPlugin;
    private NewSObjectsEditorAbstract back;
    ...
    public void giveSObject(String objectID, Player p) {
        ...
        if (optional.isPresent()) {
            ...
            if (sPlugin.isLotOfWork()) {
                ...
                else sb.append("&6&l&o" + sPlugin.getNameDesign() + " ");
                sb.append("&7This " + sPlugin.getObjectName() + " is from the ");
                if (SCore.is1v16Plus())
                ...
                sb.append("&7This " + sPlugin.getObjectName() + " is from a ");
                if (SCore.is1v16Plus())

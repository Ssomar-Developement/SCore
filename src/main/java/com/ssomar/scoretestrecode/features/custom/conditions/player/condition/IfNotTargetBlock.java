...
public class IfNotTargetBlock extends PlayerConditionFeature<ListMaterialFeature, IfNotTargetBlock> {
    ...
    public void subReset() {
        setCondition(new ListMaterialFeature(getParent(), "ifNotTargetBlock", new ArrayList<>(), "If not target block", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfNotTargetBlock getNewInstance() {
        return new IfNotTargetBlock(getParent());
    }
}

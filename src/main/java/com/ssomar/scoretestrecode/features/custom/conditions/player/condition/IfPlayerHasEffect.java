...
public class IfPlayerHasEffect extends PlayerConditionFeature<ListEffectAndLevelFeature, IfPlayerHasEffect> {
    ...
    public void subReset() {
        setCondition(new ListEffectAndLevelFeature(this, "ifPlayerHasEffect", new HashMap<>(), "If player has effect", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfPlayerHasEffect getNewInstance() {
        return new IfPlayerHasEffect(getParent());
    }
}

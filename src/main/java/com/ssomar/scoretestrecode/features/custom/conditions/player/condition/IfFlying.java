...
public class IfFlying extends PlayerConditionFeature<BooleanFeature, IfFlying> {
    ...
    public void subReset() {
        setCondition(new BooleanFeature(getParent(), "ifFlying", false, "If flying", new String[]{}, Material.LEVER, true, true));
    }
    ...
    @Override
    public IfFlying getNewInstance() {
        return new IfFlying(getParent());
    }
}

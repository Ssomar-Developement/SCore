...
public class PlaceholderCondition extends FeatureWithHisOwnEditor<PlaceholderCondition, PlaceholderCondition, PlaceholderConditionFeatureEditor, PlaceholderConditionEditorManager> {
    ...
    public List<String> load(SPlugin plugin, ConfigurationSection config, boolean isPremiumLoading) {
        ...
        if(config.isConfigurationSection(id)){
            ...
            if(com.ssomar.score.utils.PlaceholdersCdtType.getpCdtTypeWithNumber().contains(this.type.getValue().get())){
    ...
    public PlaceholderCondition clone() {
        ...
        eF.setPart2(part2.clone());
        eF.setCancelEventIfNotValid(cancelEventIfNotValid.clone());
        eF.setMessageIfNotValid(messageIfNotValid.clone());
        return eF;
    }

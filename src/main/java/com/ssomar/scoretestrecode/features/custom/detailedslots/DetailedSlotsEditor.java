...
public class DetailedSlotsEditor extends FeatureEditorInterface<DetailedSlots> {
    ...
    public DetailedSlotsEditor(DetailedSlots dropFeatures) {
        ...
        this.detailedSlots = dropFeatures.clone();
        load();
    }
    ...
    public void updateSlotOffHand(int i, boolean enable) {
        ...
        if(enable) createItem(offHandMat,					1 , i, 	"&eSlot: offHand", 	true,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        else createItem(offHandMat,					1 , i, 	"&eSlot: offHand", 	false,	false, "", "&a✎ Click here to change", "&7actually: &cDisable");
    }
    ...
    public void updateSlotBoots(int i, boolean enable) {
        if(enable) createItem(Material.DIAMOND_BOOTS,					1 , i, 	"&eSlot: boots", 	true,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        else createItem(Material.DIAMOND_BOOTS,					1 , i, 	"&eSlot: boots", 	false,	false, "", "&a✎ Click here to change", "&7actually: &cDisable");
    }
    ...
    public void updateSlotLeggings(int i, boolean enable) {
        if(enable) createItem(Material.DIAMOND_LEGGINGS,					1 , i, 	"&eSlot: leggings", 	true,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        else createItem(Material.DIAMOND_LEGGINGS,					1 , i, 	"&eSlot: leggings", 	false,	false, "", "&a✎ Click here to change", "&7actually: &cDisable");
    }
    ...
    public void updateSlotChestplate(int i, boolean enable) {
        if(enable) createItem(Material.DIAMOND_CHESTPLATE,					1 , i, 	"&eSlot: chestplate", 	true,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        else createItem(Material.DIAMOND_CHESTPLATE,					1 , i, 	"&eSlot: chestplate", 	false,	false, "", "&a✎ Click here to change", "&7actually: &cDisable");
    }
    ...
    public void updateSlotHelmet(int i, boolean enable) {
        if(enable) createItem(Material.DIAMOND_HELMET,					1 , i, 	"&eSlot: helmet", 	true,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        else createItem(Material.DIAMOND_HELMET,					1 , i, 	"&eSlot: helmet", 	false,	false, "", "&a✎ Click here to change", "&7actually: &cDisable");
    }
    ...
    public void updateSlot(int i, int slot, boolean enable) {
        if(enable) {
            if(!SCore.is1v12Less()) createItem(Material.GREEN_WOOL,					1 , i, 	"&eSlot: "+slot, 	false,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
            else createItem(Material.EMERALD,					1 , i, 	"&eSlot: "+slot, 	false,	false, "", "&a✎ Click here to change", "&7actually: &aEnable");
        }
        else {

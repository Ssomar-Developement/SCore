...
public class IfFrozen extends EntityConditionFeature<BooleanFeature, IfFrozen> {
    ...
    public void subReset() {
        setCondition(new BooleanFeature(getParent(), "ifFrozen", false, "If frozen", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfFrozen getNewInstance() {
        return new IfFrozen(getParent());
    }
}

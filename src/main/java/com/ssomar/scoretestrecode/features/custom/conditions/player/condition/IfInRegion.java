...
public class IfInRegion extends PlayerConditionFeature<ListRegionStringFeature, IfInRegion> {
    ...
    public void subReset() {
        setCondition(new ListRegionStringFeature(getParent(), "ifInRegion", new ArrayList<>(), "If in region", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfInRegion getNewInstance() {
        return  new IfInRegion(getParent());
    }
}

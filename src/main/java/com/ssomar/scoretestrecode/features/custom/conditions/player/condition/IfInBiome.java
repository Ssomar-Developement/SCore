...
public class IfInBiome extends PlayerConditionFeature<ListBiomeFeature, IfInBiome> {
    ...
    public void subReset() {
        setCondition(new ListBiomeFeature(getParent(), "ifInBiome", new ArrayList<>(), "If in biome", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfInBiome getNewInstance() {
        return new IfInBiome(getParent());
    }
}

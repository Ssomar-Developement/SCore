...
public class IfNotInWorld extends PlayerConditionFeature<ListWorldFeature, IfNotInWorld> {
    ...
    public void subReset() {
        setCondition(new ListWorldFeature(getParent(), "ifNotInWorld", new ArrayList<>(), "If not in world", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfNotInWorld getNewInstance() {
        return  new IfNotInWorld(getParent());
    }
}

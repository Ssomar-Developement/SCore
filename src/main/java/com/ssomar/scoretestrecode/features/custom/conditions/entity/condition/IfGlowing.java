...
public class IfGlowing extends EntityConditionFeature<BooleanFeature, IfGlowing> {
    ...
    public void subReset() {
        setCondition(new BooleanFeature(getParent(), "ifGlowing", false, "If glowing", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfGlowing getNewInstance() {
        return new IfGlowing(getParent());
    }
}

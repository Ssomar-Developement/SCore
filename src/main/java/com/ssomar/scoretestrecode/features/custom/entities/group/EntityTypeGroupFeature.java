...
public class EntityTypeGroupFeature extends FeatureWithHisOwnEditor<EntityTypeGroupFeature, EntityTypeGroupFeature, EntityTypeGroupFeatureEditor, EntityTypeGroupFeatureEditorManager> implements FeaturesGroup<EntityTypeForGroupFeature> {
    ...
    public EntityTypeGroupFeature(FeatureParentInterface parent, String name, String editorName, String[] editorDescription, boolean hasID, boolean useTheParentSection) {
        super(parent, name, editorName, editorDescription, Material.ZOMBIE_HEAD, false);
    ...
    @Override
    public EntityTypeGroupFeature clone() {
        EntityTypeGroupFeature eF = new EntityTypeGroupFeature(getParent(), getName(), getEditorName(), getEditorDescription(), hasID, useTheParentSection);
        eF.setEntityTypes(new HashMap<>(entityTypes));
        return eF;
    }

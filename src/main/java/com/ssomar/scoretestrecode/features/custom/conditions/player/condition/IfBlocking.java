...
public class IfBlocking extends PlayerConditionFeature<BooleanFeature, IfBlocking> {
    ...
    public void subReset() {
        setCondition(new BooleanFeature(getParent(), "ifBlocking", false, "If blocking", new String[]{}, Material.LEVER, true, true));
    }
    ...
    @Override
    public IfBlocking getNewInstance() {
        return new IfBlocking(getParent());
    }
}

...
public class IfPlayerMounts extends PlayerConditionFeature<ListEntityTypeFeature, IfPlayerMounts> {
    ...
    public void subReset() {
        setCondition(new ListEntityTypeFeature(this, "ifPlayerMounts", new ArrayList<>(), "If player mounts", new String[]{}, Material.ANVIL, false));
    }
    ...
    @Override
    public IfPlayerMounts getNewInstance() {
        return new IfPlayerMounts(getParent());
    }
}

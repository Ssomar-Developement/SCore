...
public class EntityTypeFeature extends FeatureAbstract<Optional<EntityType>, EntityTypeFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public EntityTypeFeature(FeatureParentInterface parent, String name, Optional<EntityType> defaultValue, String editorName, String [] editorDescription, Material editorMaterial, boolean requirePremium) {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        this.value = Optional.of(getEntityType( (GUI) manager.getCache().get(player)));
    }

    @Override
    public EntityTypeFeature clone() {
        EntityTypeFeature clone = new EntityTypeFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }

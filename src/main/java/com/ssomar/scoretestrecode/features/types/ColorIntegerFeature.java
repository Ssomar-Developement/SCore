...
public class ColorIntegerFeature extends FeatureAbstract<Optional<Integer>, ColorIntegerFeature> implements FeatureRequireOneMessageInEditor {
    ...
    public ColorIntegerFeature clone() {
        ColorIntegerFeature clone = new ColorIntegerFeature(getParent(), this.getName(), defaultValue, getEditorName(), getEditorDescription(), getEditorMaterial(), isRequirePremium());
        clone.value = value;
        return clone;
    }
    ...
    public Optional<String> verifyMessageReceived(String message) {
        ...
        else return Optional.of(StringConverter.coloredString("&4&l[ERROR] &cThe message you entered is not a color integer"));
    }

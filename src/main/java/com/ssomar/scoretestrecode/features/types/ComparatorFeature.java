...
public class ComparatorFeature extends FeatureAbstract<Optional<Comparator>, ComparatorFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        this.value = Optional.of(getComparator( (GUI) manager.getCache().get(player)));
    }

    @Override
    public ComparatorFeature clone() {
        ComparatorFeature clone = new ComparatorFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }

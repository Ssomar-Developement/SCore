...
public class DetailedClickFeature extends FeatureAbstract<Optional<DetailedClick>, DetailedClickFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        this.value = Optional.of(getDetailedClick( (GUI) manager.getCache().get(player)));
    }

    @Override
    public DetailedClickFeature clone() {
        DetailedClickFeature clone = new DetailedClickFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }

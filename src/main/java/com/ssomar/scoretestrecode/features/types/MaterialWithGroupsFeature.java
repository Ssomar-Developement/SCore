...
public class MaterialWithGroupsFeature extends FeatureAbstract<Optional<String>, MaterialWithGroupsFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public MaterialWithGroupsFeature(FeatureParentInterface parent, String name, Optional<String> defaultValue, String editorName, String[] editorDescription, Material editorMaterial, boolean requirePremium) {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        this.value = Optional.of(getMaterialWithGroups((GUI) manager.getCache().get(player)));
    }

    @Override
    public MaterialWithGroupsFeature clone() {
        MaterialWithGroupsFeature clone = new MaterialWithGroupsFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }
    ...
    public List<String> getSortMaterials() {
        return MaterialWithGroups.getMaterialWithGroupsList();
    }

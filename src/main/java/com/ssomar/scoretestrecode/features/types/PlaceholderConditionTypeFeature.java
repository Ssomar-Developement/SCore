...
public class PlaceholderConditionTypeFeature extends FeatureAbstract<Optional<PlaceholdersCdtType>, PlaceholderConditionTypeFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        this.value = Optional.of(getPlaceholdersCdtType( (GUI) manager.getCache().get(player)));
    }

    @Override
    public PlaceholderConditionTypeFeature clone() {
        PlaceholderConditionTypeFeature clone = new PlaceholderConditionTypeFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }

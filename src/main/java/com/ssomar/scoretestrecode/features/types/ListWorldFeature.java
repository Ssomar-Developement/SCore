...
public class ListWorldFeature extends FeatureAbstract<List<String>, ListWorldFeature> implements FeatureRequireSubTextEditorInEditor {
    ...
    public ListWorldFeature(FeatureParentInterface parent, String name, List<String> defaultValue, String editorName, String[] editorDescription, Material editorMaterial, boolean requirePremium) {
    ...
    public List<String> load(SPlugin plugin, ConfigurationSection config, boolean isPremiumLoading) {
        ...
        for(String s : config.getStringList(this.getName())){
            ...
            else errors.add("&cERROR, Couldn't load the World value of " + this.getName() + " from config, value: " + s+ " &7&o"+getParent().getParentInfo());
        }
    ...
    @Override
    public ListWorldFeature clone() {
        ListWorldFeature clone = new ListWorldFeature(getParent(), this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), isRequirePremium());

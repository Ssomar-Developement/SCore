...
public class ShapesExamples {
    ...
    public ShapesExamples(){
        ...
        examples.put("spiral", "/score particles shape:spiral particle:FLAME radius:3 density:100 time:60 drawMode:clockwise");
        ...
        examples.put("animatedCircle", "/score particles shape:animatedCircle particle:FLAME radius:3 density:100 timeToDisplay:40 drawMode:clockwise plane:xz offset:0");

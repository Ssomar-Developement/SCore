...
@Getter @Setter
public abstract class NewConditionsGUIAbstract<T extends NewConditions, Y extends Condition, Z extends ConditionsManager<T, Y>> extends GUIAbstract{

	private String detail;
	private T conditions;
	private Z conditionsManager;

	public NewConditionsGUIAbstract(String name, int size, SPlugin sPlugin, SObject sObject, SActivator sAct, String detail, T conditions, Z conditionsManager) {

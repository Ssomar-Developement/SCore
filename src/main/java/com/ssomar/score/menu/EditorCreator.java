	...
	public void sendObjects(Player target) {
		...
		if(objects.size()==0) {
			...
			for(String s : objects) {
				if(isLoreColor) toSend = new TextComponent( TextComponent.fromLegacyText(StringConverter.coloredString("&7"+cpt+".&5"+s)));
				else toSend = new TextComponent( TextComponent.fromLegacyText(StringConverter.coloredString("&7"+cpt+"."+s)));

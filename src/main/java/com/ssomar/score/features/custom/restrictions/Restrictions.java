...
public class Restrictions extends FeatureWithHisOwnEditor<Restrictions, Restrictions, RestrictionsEditor, RestrictionsEditorManager> {
    ...
    public void reset() {
        ...
        if (SCore.is1v19Plus())
            restrictions.put(RestrictionEnum.CANCEL_HORN, new BooleanFeature(this, RestrictionEnum.CANCEL_HORN.editName, defaultValues.get(RestrictionEnum.CANCEL_HORN), "Cancel Horn", new String[]{"&7&oThe horn can't be", "&7&ointeracted"}, FixedMaterial.getMaterial(Collections.singletonList("GOAT_HORN")), false, NOT_SAVE_RESTRICTIONS));
        ...
        if (!SCore.is1v13Less())
            restrictions.put(RestrictionEnum.CANCEL_STONE_CUTTER, new BooleanFeature(this, RestrictionEnum.CANCEL_STONE_CUTTER.editName, defaultValues.get(RestrictionEnum.CANCEL_STONE_CUTTER), "Cancel Stone Cutter", new String[]{"&7&oThe item can't be", "&7&oplaced in stone cutter"}, FixedMaterial.getMaterial(Collections.singletonList("STONECUTTER")), false, NOT_SAVE_RESTRICTIONS));
        ...
        if (!SCore.is1v13Less()) {
            restrictions.put(RestrictionEnum.CANCEL_LECTERN, new BooleanFeature(this, RestrictionEnum.CANCEL_LECTERN.editName, defaultValues.get(RestrictionEnum.CANCEL_LECTERN), "Cancel Lectern", new String[]{"&7&oThe item can't be", "&7&oplaced in a lectern"}, FixedMaterial.getMaterial(Collections.singletonList("LECTERN")), false, NOT_SAVE_RESTRICTIONS));
            restrictions.put(RestrictionEnum.CANCEL_LOOM, new BooleanFeature(this, RestrictionEnum.CANCEL_LOOM.editName, defaultValues.get(RestrictionEnum.CANCEL_LOOM), "Cancel Loom", new String[]{"&7&oThe item can't be", "&7&oplaced in a loom"}, FixedMaterial.getMaterial(Collections.singletonList("LOOM")), false, NOT_SAVE_RESTRICTIONS));
        }
        if (!SCore.is1v13Less())
            restrictions.put(RestrictionEnum.CANCEL_GRIND_STONE, new BooleanFeature(this, RestrictionEnum.CANCEL_GRIND_STONE.editName, defaultValues.get(RestrictionEnum.CANCEL_GRIND_STONE), "Cancel Grind Stone", new String[]{"&7&oThe item can't be", "&7&oplaced in a grind stone"}, FixedMaterial.getMaterial(Collections.singletonList("GRINDSTONE")), false, NOT_SAVE_RESTRICTIONS));
        restrictions.put(RestrictionEnum.CANCEL_ARMORSTAND, new BooleanFeature(this, RestrictionEnum.CANCEL_ARMORSTAND.editName, defaultValues.get(RestrictionEnum.CANCEL_ARMORSTAND), "Cancel ArmorStand", new String[]{"&7&oThe item can't be", "&7&oplaced on an armorstand"}, Material.ARMOR_STAND, false, NOT_SAVE_RESTRICTIONS));
        ...
        if (!SCore.is1v13Less())
            restrictions.put(RestrictionEnum.CANCEL_SMITHING_TABLE, new BooleanFeature(this, RestrictionEnum.CANCEL_SMITHING_TABLE.editName, defaultValues.get(RestrictionEnum.CANCEL_SMITHING_TABLE), "Cancel Smithing Table", new String[]{"&7&oThe item can't be", "&7&oplaced in a smithing table"}, FixedMaterial.getMaterial(Collections.singletonList("SMITHING_TABLE")), false, NOT_SAVE_RESTRICTIONS));
        ...
        restrictions.put(RestrictionEnum.CANCEL_HORSE, new BooleanFeature(this, RestrictionEnum.CANCEL_HORSE.editName, defaultValues.get(RestrictionEnum.CANCEL_HORSE), "Cancel Horse", new String[]{"&7&oThe item can't be", "&7&oplaced in/on an horse"}, FixedMaterial.getMaterial(Arrays.asList("HORSE_SPAWN_EGG", "SADDLE")), false, NOT_SAVE_RESTRICTIONS));

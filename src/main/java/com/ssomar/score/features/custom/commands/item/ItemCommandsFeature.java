package com.ssomar.score.features.custom.commands.item;
...
@Getter
@Setter
public class ItemCommandsFeature extends CommandsAbstractFeature<List<String>, ItemCommandsFeature> implements FeatureRequireSubTextEditorInEditor {

    private List<String> value;

    public ItemCommandsFeature(FeatureParentInterface parent, FeatureSettingsInterface featureSettings) {
    ...
    public List<String> load(SPlugin plugin, ConfigurationSection config, boolean isPremiumLoading) {
        ...
        value = ItemCommandManager.getInstance().getCommandsVerified(plugin, config.getStringList(getName()), errors, getParent().getParentInfo());
        return errors;
    }
    ...
    public void runCommands(ActionInfo actionInfo, String objectName) {
        ...
        ItemRunCommandsBuilder builder = new ItemRunCommandsBuilder(commands, actionInfo);
    ...
    @Override
    public ItemCommandsFeature initItemParentEditor(GUI gui, int slot) {
    ...
    @Override
    public ItemCommandsFeature clone(FeatureParentInterface newParent) {
        ItemCommandsFeature clone = new ItemCommandsFeature(newParent, getFeatureSettings());
    ...
    public Optional<String> verifyMessageReceived(String message) {
        return ItemCommandManager.getInstance().verifCommand(message);
    }
    ...
    public List<Suggestion> getSuggestions() {
        ...
        for (SCommand command : ItemCommandManager.getInstance().getCommands()) {
    ...
    public void sendBeforeTextEditor(Player p, NewGUIManager manager) {
        ...
        TextComponent variables = new TextComponent(StringConverter.coloredString("&7➤ WIKI of Item commands: &8&l[CLICK HERE]"));
        variables.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://docs.ssomar.com/tools/custom-commands/item-commands"));
        ...
        EditorCreator editor = new EditorCreator(beforeMenu, (List<String>) manager.currentWriting.get(p), "Item Commands", false, true, true, true, true, true, false, "", commands);

...
///*@Getter
//@Setter
//public class consumableFeatures extends FeatureWithHisOwnEditor<consumableFeatures, consumableFeatures, GenericFeatureParentEditor, GenericFeatureParentEditorManager> {
//
//
//    private IntegerFeature enable;
//    private IntegerFeature animation;
...
//    @Override
//    public void reset() {
//        enable = new IntegerFeature(this, Optional.of(1), FeatureSettingsSCore.nutrition);

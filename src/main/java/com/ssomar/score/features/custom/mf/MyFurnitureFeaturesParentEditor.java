...
public class MyFurnitureFeaturesParentEditor extends FeatureEditorInterface<FeatureParentInterface> {

    private FeatureParentInterface featureParent;

    public MyFurnitureFeaturesParentEditor(FeatureParentInterface featureParent) {

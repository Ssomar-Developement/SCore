...
@Getter
@Setter
public class RequiredMana extends FeatureWithHisOwnEditor<RequiredMana, RequiredMana, GenericFeatureParentEditor, GenericFeatureParentEditorManager> implements RequiredPlayerInterface {
    ...
    public void reset() {
        ...
        this.errorMessage = new ColoredStringFeature(getParent(), Optional.of("&4&l>> &cError you don't have the required mana"), FeatureSettingsSCore.errorMessage);

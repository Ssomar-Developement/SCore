...
public enum FeatureSettingsSCoreZH implements FeatureSettingsInterface {
    ...
    disableBlockingTime("disableBlockingTime", "禁用格挡时间", new String[]{"&7&o禁用格挡所需的时间", "&7&o以刻为单位"}, GUI.CLOCK),
    damagePerAttack("damagePerAttack", "每次攻击伤害", new String[]{"&7&o每次攻击造成的伤害"}, GUI.CLOCK),
    weaponFeatures("weaponFeatures", "武器特性", new String[]{"&7&o武器的特性"}, Material.DIAMOND_SWORD),
    ifUseCooldown("ifUseCooldown", "是否使用冷却", new String[]{}, Material.ANVIL),
    input1("input1", "输入 1", new String[]{}, Material.GLASS),
    input2("input2", "输入 2", new String[]{}, Material.GLASS),
    input3("input3", "输入 3", new String[]{}, Material.GLASS),
    input4("input4", "输入 4", new String[]{}, Material.GLASS),
    input5("input5", "输入 5", new String[]{}, Material.GLASS),
    input6("input6", "输入 6", new String[]{}, Material.GLASS),
    input7("input7", "输入 7", new String[]{}, Material.GLASS),
    input8("input8", "输入 8", new String[]{}, Material.GLASS),
    input9("input9", "输入 9", new String[]{}, Material.GLASS),
    itemCheckerType("itemCheckerType", "物品检查类型", new String[]{"&7&o物品检查的类型"}, Material.ANVIL),
    itemCheckers("itemCheckers", "物品检查器", new String[]{"&7&o用于检查物品的设置"}, Material.ANVIL),
    potionSettings("potionFeatures", "药水设置", new String[]{"&7&o药水的设置"}, FixedMaterial.getBrewingStand()),
    checkAmount("checkAmount", "检查数量", new String[]{"&7&o检查物品的数量"}, null),
    checkDisplayName("checkDisplayName", "检查显示名称", new String[]{"&7&o检查物品的显示名称"}, null),
    checkMaterial("checkMaterial", "检查材质", new String[]{"&7&o检查物品的材质"}, null),
    checkCustomModelData("checkCustomModelData", "检查自定义模型数据", new String[]{"&7&o检查自定义模型数据"}, null),
    checkLore("checkLore", "检查描述", new String[]{"&7&o检查物品的描述（lore）"}, null),
    checkDurability("checkDurability", "检查耐久度", new String[]{"&7&o检查物品的耐久度"}, null),
    checkExecutableItemID("checkExecutableItemID", "检查可执行物品 ID", new String[]{"&7&o检查可执行物品的 ID"}, null),
    checkExecutableItemUsage("checkExecutableItemUsage", "检查可执行物品使用次数", new String[]{"&7&o检查可执行物品的使用情况"}, null),
    checkExecutableItemVariables("checkExecutableItemVariables", "检查可执行物品变量", new String[]{"&7&o检查可执行物品中的变量"}, null),
    anvilMergeType("anvilMergeType", "铁砧合并类型", new String[]{"&7&o铁砧中物品的合并方式"}, Material.ANVIL),
    itemCommands("itemCommands", "物品指令", new String[]{"&7&o要执行的物品指令"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    playerSettings("playerSettings", "玩家设置", new String[]{"&7&o与玩家相关的设置"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    targetItemCommands("targetItemCommands", "目标物品指令", new String[]{"&7&o要对目标物品执行的指令"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    maxFurnitureRendered("maxFurnitureRendered", "最大家具渲染数量", new String[]{"&7&o渲染的最大家具数量"}, GUI.CLOCK),
    viewDistanceFurniture("viewDistanceFurniture", "家具视距", new String[]{"&7&o家具的可视距离"}, GUI.CLOCK),
    maxDistanceBoundingBoxCalculation("maxDistanceBoundingBoxCalculation", "最大边界盒计算距离", new String[]{"&7&o边界盒计算的最大距离", "&7&o如遇 FPS 问题建议设置为 3-5"}, GUI.CLOCK),
    updateEquippable("updateEquippable", "更新可装备物品", new String[]{"&7&o更新物品的可装备特性"}, null),
    RECIPE("RECIPE", "合成配方", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    RECIPEGROUP("RECIPEGROUP", "配方组", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    spawnerFeatures("spawnerFeatures", "刷怪笼特性", new String[]{"&7&o刷怪笼的功能设置"}, FixedMaterial.getMaterial(Arrays.asList("SPAWNER"))),
    spawnDelay("spawnDelay", "生成延迟", new String[]{"&7&o怪物生成的延迟时间"}, GUI.CLOCK),
    playerCanSit("playerCanSit", "玩家可坐下", new String[]{"&7&o玩家可以坐下"}, FixedMaterial.getMaterial(Arrays.asList("STONE_STAIRS"))),
    sitFeatures("sitFeatures", "坐下功能", new String[]{"&7&o坐下的相关功能"}, FixedMaterial.getMaterial(Arrays.asList("STONE_STAIRS"))),
    storageFeatures("storageFeatures", "存储功能", new String[]{"&7&o存储功能设置"}, FixedMaterial.getMaterial(Arrays.asList("CHEST"))),
    usageFeatures("usageFeatures", "使用功能", new String[]{"&7&o使用相关的功能", "&a增加 &7&o或 &c减少 &7&o使用值", "&e使用 UsageModification &7&o在触发器中进行调整"}, Material.BUCKET),
    myFurnitureFeatures("myFurnitureFeatures", "MyFurniture 功能", new String[]{"&7&oMyFurniture 插件相关功能"}, FixedMaterial.getMaterial(Arrays.asList("BOOKSHELF"))),
    myfurnitureID("myfurnitureID", "MyFurniture ID", new String[]{"&7&oMyFurniture 的唯一标识符"}, FixedMaterial.getMaterial(Arrays.asList("BOOKSHELF"))),
    animation("animation", "动画", new String[]{"&7&o动画设置"}, Material.ANVIL),
    hasConsumeParticles("hasConsumeParticles", "有消耗粒子效果", new String[]{"&7&o是否有消耗时的粒子效果"}, Material.ANVIL),
    consumeSeconds("consumeSeconds", "消耗时间（秒）", new String[]{"&7&o消耗所需的秒数"}, GUI.CLOCK),
    consumableFeatures("consumableFeatures", "可消耗功能", new String[]{"&7&o关于可消耗物品的功能"}, FixedMaterial.getMaterial(Arrays.asList("POTION"))),
    viewRange("viewRange", "视野范围", new String[]{"&7&o物品或功能的视野范围"}, GUI.CLOCK),

    minSpawnDelay("minSpawnDelay", "最小生成延迟", new String[]{"&7&o最小生成延迟"}, GUI.CLOCK),
    maxSpawnDelay("maxSpawnDelay", "最大生成延迟", new String[]{"&7&o最大生成延迟"}, GUI.CLOCK),
    spawnCount("spawnCount", "生成数量", new String[]{"&7&o每次生成的实体数量"}, GUI.CLOCK),
    spawnRange("spawnRange", "生成范围", new String[]{"&7&o实体生成的范围"}, GUI.CLOCK),
    requiredPlayerRange("requiredPlayerRange", "所需玩家距离", new String[]{"&7&o要求玩家靠近的距离"}, GUI.CLOCK),
    maxNearbyEntities("maxNearbyEntities", "最大邻近实体数", new String[]{"&7&o附近允许存在的最大实体数量"}, GUI.CLOCK),
    potentialSpawns("potentialSpawns", "潜在生成实体", new String[]{"&7&o可能生成的实体"}, Material.ANVIL),
    addSpawnerNbtToItem("addSpawnerNbtToItem", "添加刷怪笼 NBT 到物品", new String[]{"&7&o将刷怪笼的 NBT 添加到物品中", "&c提示：Minecraft 会在说明中显示警告"}, null),
    nexoID("nexoID", "Nexo", new String[]{"&7&oNexo 的 ID"}, Material.DIAMOND_BLOCK),
    recipesList("recipesList", "配方列表", new String[]{"&7&o所有的配方列表"}, Material.ANVIL),
    typeOfCraftingTableRecipe("typeOfCraftingTableRecipe", "工作台配方类型", new String[]{"&7&o工作台配方的类型"}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    cookingTime("cookingTime", "烹饪时间", new String[]{"&7&o所需的烹饪时间"}, GUI.CLOCK),
    experience("experience", "经验值", new String[]{"&7&o可获得的经验值"}, GUI.CLOCK),
    result("result", "结果", new String[]{"&7&o合成的结果"}, Material.ANVIL),
    recipeType("recipeType", "配方类型", new String[]{"&7&o配方的类型"}, Material.ANVIL),

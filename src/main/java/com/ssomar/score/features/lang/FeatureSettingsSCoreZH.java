...
public enum FeatureSettingsSCoreZH implements FeatureSettingsInterface {
    ...
    potionFeatures("potionFeatures", "药水设置", new String[]{"&7&o药水的相关设置"}, FixedMaterial.getBrewingStand()),
    ...
    titleAdjustment("titleAdjustment", "标题微调", new String[]{"&7&o标题位置或显示的微调"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleFeatures("titleFeatures", "标题选项", new String[]{"&7&o标题相关特性"}, Material.ANVIL),
    ...
    cooldownFeatures("cooldownFeatures", "冷却选项", new String[]{"&7&o冷却相关选项"}, GUI.CLOCK),
    globalCooldownFeatures("globalCooldownFeatures", "全局冷却选项", new String[]{"&7&o全局冷却设置", "&7&o(对 &e所有 &7&o玩家和实体生效)"}, GUI.CLOCK),
    ...
    playerCooldownFeatures("playerCooldownFeatures", "玩家冷却选项", new String[]{"&7&o玩家冷却选项"}, GUI.CLOCK),
    entityCooldownFeatures("entityCooldownFeatures", "实体冷却选项", new String[]{"&7&o实体冷却选项"}, GUI.CLOCK),
    ...
    food("foodFeatures", "食物特性", new String[]{"&7&o食物特性"}, Material.COOKED_BEEF),
    ...
    dropFeatures("dropFeatures", "掉落选项", new String[]{"&7&o物品掉落相关设置"}, Material.ANVIL),
    ...
    giveFirstJoinFeatures("giveFirstJoinFeatures", "首次加入给予", new String[]{"&7&o玩家首次加入服务器时给予物品的相关设置"}, Material.ANVIL),

...
public enum FeatureSettingsSCoreES implements FeatureSettingsInterface {
    ...
    potionSettings("potionFeatures", "Configuración de Pociones", new String[]{"&7&oLa configuración de las pociones"}, FixedMaterial.getBrewingStand()),
    ...
    food("foodFeatures", "Características de Comida", new String[]{"&7&oCaracterísticas de comida"}, Material.COOKED_BEEF),

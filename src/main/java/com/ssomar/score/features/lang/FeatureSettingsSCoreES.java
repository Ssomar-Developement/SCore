...
public enum FeatureSettingsSCoreES implements FeatureSettingsInterface {
    ...
    dropOptions("dropOptions", "Opciones de Drop", new String[]{"&7&oLas características de drop"}, Material.ANVIL),
    ...
    enable("enable", "Activar", new String[]{"&7&oActivar las características de la herramienta"}, Material.LEVER),
    ...
    entityCooldownOptions("entityCooldownOptions", "Opciones de Enfriamiento de Entidad", new String[]{"&7&oEl enfriamiento de la entidad"}, GUI.CLOCK),
    ...
    food("food", "Características de Comida", new String[]{"&7&oCaracterísticas de comida"}, Material.COOKED_BEEF),
    ...
    giveFirstJoinFeatures("giveFirstJoin", "Características de Primer Ingreso", new String[]{"&7&oLas características de dar al primer ingreso"}, Material.ANVIL),
    ...
    globalCooldownOptions("globalCooldownOptions", "Opciones de Enfriamiento Global", new String[]{"&7&oEl enfriamiento global", "&7&o(Para &eTODOS &7&olos jugadores y entidades)"}, GUI.CLOCK),
    ...
    playerCooldownOptions("playerCooldownOptions", "Opciones de Enfriamiento de Jugador", new String[]{"&7&oEl enfriamiento del jugador"}, GUI.CLOCK),
    ...
    potionSettings("potionSettings", "Configuración de Poción", new String[]{"&7&oLa configuración de la poción"}, FixedMaterial.getBrewingStand()),
    ...
    titleAdjustement("titleAdjustement", "Ajuste de Título", new String[]{"&7&oAjuste de título"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "Opciones de Título", new String[]{"&7&oLas características del título"}, Material.ANVIL),
    ...
    cooldownOptions("cooldownOptions", "Opciones de Enfriamiento", new String[]{"&7&oEl enfriamiento"}, GUI.CLOCK),

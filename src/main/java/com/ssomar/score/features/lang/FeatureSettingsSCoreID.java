...
public enum FeatureSettingsSCoreID implements FeatureSettingsInterface {
    ...
    dropFeatures("dropFeatures", "Opsi Drop", new String[]{"&7&oFitur drop"}, Material.DROPPER),
    ...
    foodFeatures("foodFeatures", "Fitur Makanan", new String[]{"&7&oFitur makanan"}, Material.COOKED_BEEF),

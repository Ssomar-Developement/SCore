...
public enum FeatureSettingsSCoreID implements FeatureSettingsInterface {
    ...
    cooldownOptions("cooldownOptions", "Opsi Cooldown", new String[]{"&7&oCooldown"}, GUI.CLOCK),
    ...
    dropOptions("dropOptions", "Opsi Drop", new String[]{"&7&oFitur drop"}, Material.ANVIL),
    ...
    entityCooldownOptions("entityCooldownOptions", "Opsi Cooldown Entitas", new String[]{"&7&oCooldown entitas"}, GUI.CLOCK),
    ...
    globalCooldownOptions("globalCooldownOptions", "Opsi Cooldown Global", new String[]{"&7&oCooldown global", "&7&o(Untuk &eSEMUA &7&opemain dan entitas)"}, GUI.CLOCK),
    ...
    playerCooldownOptions("playerCooldownOptions", "Opsi Cooldown Pemain", new String[]{"&7&oCooldown pemain"}, GUI.CLOCK),
    ...
    titleAdjustement("titleAdjustement", "Penyesuaian Judul", new String[]{"&7&oPenyesuaian judul"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "Opsi Judul", new String[]{"&7&oFitur judul"}, Material.ANVIL),

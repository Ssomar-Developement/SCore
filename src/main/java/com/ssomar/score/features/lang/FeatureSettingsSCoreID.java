...
public enum FeatureSettingsSCoreID implements FeatureSettingsInterface {
    ...
    disableBlockingTime("disableBlockingTime", "Nonaktifkan Waktu Memblokir", new String[]{"&7&oWaktu untuk menonaktifkan pemblokiran", "&7&odalam tick"}, GUI.CLOCK),
    damagePerAttack("damagePerAttack", "Kerusakan per Serangan", new String[]{"&7&oJumlah kerusakan per serangan"}, GUI.CLOCK),
    weaponFeatures("weaponFeatures", "Fitur Senjata", new String[]{"&7&oFitur-fitur dari senjata"}, Material.DIAMOND_SWORD),
    ifUseCooldown("ifUseCooldown", "Gunakan Cooldown", new String[]{}, Material.ANVIL),
    ...
    itemCheckerType("itemCheckerType", "Tipe Pemeriksa Item", new String[]{"&7&oJenis pemeriksaan item"}, Material.ANVIL),
    itemCheckers("itemCheckers", "Pemeriksa Item", new String[]{"&7&oPemeriksa item yang digunakan"}, Material.ANVIL),
    potionSettings("potionFeatures", "Pengaturan Ramuan", new String[]{"&7&oPengaturan untuk ramuan"}, FixedMaterial.getBrewingStand()),
    checkAmount("checkAmount", "Periksa Jumlah", new String[]{"&7&oPeriksa jumlah item"}, null),
    checkDisplayName("checkDisplayName", "Periksa Nama Tampilan", new String[]{"&7&oPeriksa nama tampilan item"}, null),
    checkMaterial("checkMaterial", "Periksa Material", new String[]{"&7&oPeriksa material item"}, null),
    checkCustomModelData("checkCustomModelData", "Periksa Data Model Kustom", new String[]{"&7&oPeriksa data model kustom"}, null),
    checkLore("checkLore", "Periksa Lore", new String[]{"&7&oPeriksa lore item"}, null),
    checkDurability("checkDurability", "Periksa Daya Tahan", new String[]{"&7&oPeriksa daya tahan item"}, null),
    checkExecutableItemID("checkExecutableItemID", "Periksa ID Item Eksekusi", new String[]{"&7&oPeriksa ID item yang dapat dieksekusi"}, null),
    checkExecutableItemUsage("checkExecutableItemUsage", "Periksa Penggunaan Item Eksekusi", new String[]{"&7&oPeriksa penggunaan item yang dapat dieksekusi"}, null),
    checkExecutableItemVariables("checkExecutableItemVariables", "Periksa Variabel Item Eksekusi", new String[]{"&7&oPeriksa variabel dari item yang dapat dieksekusi"}, null),
    anvilMergeType("anvilMergeType", "Tipe Penggabungan Landasan", new String[]{"&7&oTipe penggabungan item di landasan"}, Material.ANVIL),
    itemCommands("itemCommands", "Perintah Item", new String[]{"&7&oPerintah yang dijalankan oleh item"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    playerSettings("playerSettings", "Pengaturan Pemain", new String[]{"&7&oPengaturan yang berkaitan dengan pemain"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    targetItemCommands("targetItemCommands", "Perintah Item Target", new String[]{"&7&oPerintah untuk item target"}, FixedMaterial.getMaterial(Arrays.asList("COMMAND_BLOCK", "COMMAND"))),
    maxFurnitureRendered("maxFurnitureRendered", "Jumlah Maksimal Furnitur Ditampilkan", new String[]{"&7&oJumlah maksimum furnitur yang dirender"}, GUI.CLOCK),
    viewDistanceFurniture("viewDistanceFurniture", "Jarak Pandang Furnitur", new String[]{"&7&oJarak pandang furnitur"}, GUI.CLOCK),
    maxDistanceBoundingBoxCalculation("maxDistanceBoundingBoxCalculation", "Jarak Maksimum Perhitungan Batas", new String[]{"&7&oJarak maksimum untuk perhitungan bounding box", "&7&oGunakan 3–5 jika mengalami masalah FPS"}, GUI.CLOCK),
    updateEquippable("updateEquippable", "Perbarui Item yang Dapat Dipakai", new String[]{"&7&oPerbarui fitur item yang dapat dipakai"}, null),
    RECIPE("RECIPE", "Resep", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    RECIPEGROUP("RECIPEGROUP", "Grup Resep", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    spawnerFeatures("spawnerFeatures", "Fitur Spawner", new String[]{"&7&oFitur-fitur dari spawner"}, FixedMaterial.getMaterial(Arrays.asList("SPAWNER"))),
    spawnDelay("spawnDelay", "Tunda Spawn", new String[]{"&7&oPenundaan waktu sebelum spawn"}, GUI.CLOCK),
    minSpawnDelay("minSpawnDelay", "Tunda Spawn Minimum", new String[]{"&7&oPenundaan minimum untuk spawn"}, GUI.CLOCK),
    maxSpawnDelay("maxSpawnDelay", "Tunda Spawn Maksimum", new String[]{"&7&oPenundaan maksimum untuk spawn"}, GUI.CLOCK),
    spawnCount("spawnCount", "Jumlah Spawn", new String[]{"&7&oJumlah entitas yang muncul"}, GUI.CLOCK),
    spawnRange("spawnRange", "Jangkauan Spawn", new String[]{"&7&oJarak jangkauan spawn"}, GUI.CLOCK),
    requiredPlayerRange("requiredPlayerRange", "Jangkauan Pemain Diperlukan", new String[]{"&7&oJarak maksimum pemain harus berada"}, GUI.CLOCK),
    maxNearbyEntities("maxNearbyEntities", "Maks Entitas Sekitar", new String[]{"&7&oJumlah maksimum entitas di sekitar"}, GUI.CLOCK),
    potentialSpawns("potentialSpawns", "Kemungkinan Spawn", new String[]{"&7&oKemungkinan entitas yang dapat muncul"}, Material.ANVIL),
    addSpawnerNbtToItem("addSpawnerNbtToItem", "Tambahkan NBT Spawner ke Item", new String[]{"&7&oTambahkan data NBT dari spawner ke item", "&cPeringatan Minecraft akan muncul di lore"}, null),
    nexoID("nexoID", "Nexo", new String[]{"&7&oID dari Nexo"}, Material.DIAMOND_BLOCK),
    recipesList("recipesList", "Daftar Resep", new String[]{"&7&oDaftar resep yang tersedia"}, Material.ANVIL),
    typeOfCraftingTableRecipe("typeOfCraftingTableRecipe", "Jenis Resep Meja Kerajinan", new String[]{"&7&oJenis resep untuk meja kerajinan"}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    cookingTime("cookingTime", "Waktu Memasak", new String[]{"&7&oWaktu yang dibutuhkan untuk memasak"}, GUI.CLOCK),
    experience("experience", "Pengalaman", new String[]{"&7&oPengalaman yang diberikan"}, GUI.CLOCK),
    result("result", "Hasil", new String[]{"&7&oHasil dari resep"}, Material.ANVIL),
    recipeType("recipeType", "Tipe Resep", new String[]{"&7&oJenis resep"}, Material.ANVIL),
    ...
    food("foodFeatures", "Fitur Makanan", new String[]{"&7&oFitur makanan"}, Material.COOKED_BEEF),
    ...
    giveFirstJoinFeatures("giveFirstJoinFeatures", "Fitur Pemberian Pertama Bergabung", new String[]{"&7&oFitur pemberian pertama bergabung"}, Material.ANVIL),
    ...
    potionFeatures("potionFeatures", "Pengaturan Ramuan", new String[]{"&7&oPengaturan ramuan"}, FixedMaterial.getBrewingStand()),

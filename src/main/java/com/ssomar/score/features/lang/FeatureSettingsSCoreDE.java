...
public enum FeatureSettingsSCoreDE implements FeatureSettingsInterface {
    ...
    cooldownOptions("cooldownOptions", "Abklingzeit-Optionen", new String[]{"&7&oDie Abklingzeit"}, GUI.CLOCK),
    ...
    dropOptions("dropOptions", "Fall-Optionen", new String[]{"&7&oDie Fall-Funktionen"}, Material.ANVIL),
    ...
    entityCooldownOptions("entityCooldownOptions", "Entitäts-Abklingzeit-Optionen", new String[]{"&7&oDie Entitäts-Abklingzeit"}, GUI.CLOCK),
    ...
    globalCooldownOptions("globalCooldownOptions", "Globale Abklingzeit-Optionen", new String[]{"&7&oDie globale Abklingzeit", "&7&o(Für &eALLE &7&oSpieler und Entitäten)"}, GUI.CLOCK),
    ...
    playerCooldownOptions("playerCooldownOptions", "Spieler-Abklingzeit-Optionen", new String[]{"&7&oDie Spieler-Abklingzeit"}, GUI.CLOCK),
    ...
    titleAdjustement("titleAdjustement", "Titelanpassung", new String[]{"&7&oTitelanpassung"},  FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "Titel-Optionen", new String[]{"&7&oDie Titel-Funktionen"},  Material.ANVIL),

...
public enum FeatureSettingsSCoreDE implements FeatureSettingsInterface {
    ...
    dropFeatures("dropFeatures", "Fall-Optionen", new String[]{"&7&oDie Fall-Funktionen"}, Material.DROPPER),
    ...
    foodFeatures("foodFeatures", "Nahrung-Funktionen", new String[]{"&7&oNahrung-Funktionen"}, Material.COOKED_BEEF),

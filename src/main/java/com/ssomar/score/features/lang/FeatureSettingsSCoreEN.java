...
public enum FeatureSettingsSCoreEN implements FeatureSettingsInterface {
    ...
    cooldownOptions("cooldownOptions", "Cooldown Options", new String[]{"&7&oThe cooldown"}, GUI.CLOCK),
    ...
    damagePerAttack("damagePerAttack", "Damage Per Attack", new String[]{"&7&oThe damage per attack"}, GUI.CLOCK),
    disableBlockingTime("disableBlockingTime", "Disable Blocking Time", new String[]{"&7&oThe time to disable blocking", "&7&oin ticks"}, GUI.CLOCK),
    ...
    dropOptions("dropOptions", "Drop Options", new String[]{"&7&oThe drop features"}, Material.ANVIL),
    ...
    entityCooldownOptions("entityCooldownOptions", "Entity Cooldown Options", new String[]{"&7&oThe entity cooldown"}, GUI.CLOCK),
    ...
    food("food", "Food Features", new String[]{"&7&oFood features"}, Material.COOKED_BEEF),
    ...
    giveFirstJoinFeatures("giveFirstJoin", "Give first join features", new String[]{"&7&oThe give first join features"}, Material.ANVIL),
    ...
    globalCooldownOptions("globalCooldownOptions", "Global Cooldown Options", new String[]{"&7&oThe global cooldown", "&7&o(For &eALL &7&oplayers and entities)"}, GUI.CLOCK),
    ...
    placeholderCondition("placeholderCondition", "Placeholder Condition", new String[]{"&7&oA Placeholder condition with its options"}, GUI.WRITABLE_BOOK),
    ...
    potionSettings("potionSettings", "Potion Settings", new String[]{"&7&oThe potion settings"}, FixedMaterial.getBrewingStand()),
    ...
    subPattern("subPattern", "Sub Pattern", new String[]{"&7&oA sub pattern with its options"}, Material.ANVIL),
    ...
    titleAdjustement("titleAdjustement", "Title adjustement", new String[]{"&7&oTitle adjustement"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "Title Options", new String[]{"&7&oThe title features"}, Material.ANVIL),
    ...
    variable("variable", "Variable", new String[]{"&7&oA variable with its options"}, GUI.WRITABLE_BOOK),
    variableName("variableName", "Variable Name", new String[]{"&7&oThe variable name", "&7&othat you want create/modify"}, GUI.WRITABLE_BOOK),
    variableUpdate("variableUpdate", "Variable Update", new String[]{"&7&oA variable update with its options"}, GUI.WRITABLE_BOOK),

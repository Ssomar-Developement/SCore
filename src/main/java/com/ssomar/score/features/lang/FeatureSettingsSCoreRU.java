...
public enum FeatureSettingsSCoreRU implements FeatureSettingsInterface {
    ...
    dropFeatures("dropFeatures", "Настройки Выпадения", new String[]{"&7&oНастройки выпадения"}, Material.DROPPER),
    ...
    foodFeatures("foodFeatures", "Настройки Еды", new String[]{"&7&oНастройки еды"}, Material.COOKED_BEEF),
    ...
    dyeFeatures("dyeFeatures", "Функции Красителя", new String[]{"&7&oПозволяет использовать предмет как краситель (26.1+)"}, FixedMaterial.getMaterial(Arrays.asList("PINK_DYE", "INK_SACK"))),
    dyeColor("dyeColor", "Цвет Красителя", new String[]{"&7&oЦвет красителя у предмета"}, FixedMaterial.getMaterial(Arrays.asList("PINK_DYE", "INK_SACK"))),
    sulfurCubeContentFeatures("sulfurCubeContentFeatures", "Содержимое Серного Куба", new String[]{"&7&oПредмет, поглощённый серным кубом (26.2+)"}, FixedMaterial.getMaterial(Arrays.asList("BUCKET"))),
    absorbedItem("absorbedItem", "Поглощённый Предмет", new String[]{"&7&oПредмет, хранящийся внутри серного куба"}, FixedMaterial.getMaterial(Arrays.asList("BUCKET"))),
    attackRangeFeatures("attackRangeFeatures", "Функции Дальности Атаки", new String[]{"&7&oДальность атаки оружия (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    minReach("minReach", "Мин. Дальность", new String[]{"&7&oМинимальная дальность атаки в блоках"}, GUI.CLOCK),
    maxReach("maxReach", "Макс. Дальность", new String[]{"&7&oМаксимальная дальность атаки в блоках"}, GUI.CLOCK),
    minCreativeReach("minCreativeReach", "Мин. Дальность в Творческом", new String[]{"&7&oМинимальная дальность атаки в творческом режиме"}, GUI.CLOCK),
    maxCreativeReach("maxCreativeReach", "Макс. Дальность в Творческом", new String[]{"&7&oМаксимальная дальность атаки в творческом режиме"}, GUI.CLOCK),
    hitboxMargin("hitboxMargin", "Запас Хитбокса", new String[]{"&7&oДополнительный запас вокруг хитбокса цели"}, GUI.CLOCK),
    mobFactor("mobFactor", "Множитель для Мобов", new String[]{"&7&oМножитель дальности, когда предмет держит моб"}, GUI.CLOCK),
    piercingWeaponFeatures("piercingWeaponFeatures", "Функции Пробивающего Оружия", new String[]{"&7&oОружие пробивает существ насквозь (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    dealsKnockback("dealsKnockback", "Наносит Отбрасывание", new String[]{"&7&oНаносит ли пробивающая атака отбрасывание"}, null),
    dismounts("dismounts", "Сбрасывает с Транспорта", new String[]{"&7&oСбрасывает ли атака существ с транспорта"}, null),
    enableHitSound("enableHitSound", "Включить Звук Удара", new String[]{"&7&oВключить звук при попадании по существу"}, null),
    kineticWeaponFeatures("kineticWeaponFeatures", "Функции Кинетического Оружия", new String[]{"&7&oРазгонная атака, зависящая от скорости (1.21.11+)"}, FixedMaterial.getMaterial(Arrays.asList("DIAMOND_SWORD"))),
    contactCooldownTicks("contactCooldownTicks", "Перезарядка Контакта (тики)", new String[]{"&7&oПерезарядка в тиках между двумя контактами"}, GUI.CLOCK),
    delayTicks("delayTicks", "Задержка (тики)", new String[]{"&7&oЗадержка в тиках до начала кинетического эффекта"}, GUI.CLOCK),
    forwardMovement("forwardMovement", "Движение Вперёд", new String[]{"&7&oДвижение вперёд во время рывка"}, GUI.CLOCK),
    damageMultiplier("damageMultiplier", "Множитель Урона", new String[]{"&7&oМножитель урона при кинетическом попадании"}, GUI.CLOCK),
    dismountMaxDurationTicks("dismountMaxDurationTicks", "Сброс — Макс. Длительность (тики)", new String[]{"&7&oСколько тиков условие сброса остаётся активным"}, GUI.CLOCK),
    dismountMinSpeed("dismountMinSpeed", "Сброс — Мин. Скорость", new String[]{"&7&oМинимальная скорость для сброса с транспорта"}, GUI.CLOCK),
    dismountMinRelativeSpeed("dismountMinRelativeSpeed", "Сброс — Мин. Относительная Скорость", new String[]{"&7&oМинимальная относительная скорость для сброса"}, GUI.CLOCK),
    knockbackMaxDurationTicks("knockbackMaxDurationTicks", "Отбрасывание — Макс. Длительность (тики)", new String[]{"&7&oСколько тиков условие отбрасывания остаётся активным"}, GUI.CLOCK),
    knockbackMinSpeed("knockbackMinSpeed", "Отбрасывание — Мин. Скорость", new String[]{"&7&oМинимальная скорость для отбрасывания"}, GUI.CLOCK),
    knockbackMinRelativeSpeed("knockbackMinRelativeSpeed", "Отбрасывание — Мин. Относительная Скорость", new String[]{"&7&oМинимальная относительная скорость для отбрасывания"}, GUI.CLOCK),
    damageMaxDurationTicks("damageMaxDurationTicks", "Урон — Макс. Длительность (тики)", new String[]{"&7&oСколько тиков условие урона остаётся активным"}, GUI.CLOCK),
    damageMinSpeed("damageMinSpeed", "Урон — Мин. Скорость", new String[]{"&7&oМинимальная скорость для кинетического урона"}, GUI.CLOCK),
    damageMinRelativeSpeed("damageMinRelativeSpeed", "Урон — Мин. Относительная Скорость", new String[]{"&7&oМинимальная относительная скорость для кинетического урона"}, GUI.CLOCK),
    canBeSheared("canBeSheared", "Можно Состричь", new String[]{"&7&oМожно ли состричь предмет с", "&7&oсущества, которое его носит (например, ножницами)"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    enableShearingSound("enableShearingSound", "Включить Звук Стрижки", new String[]{"&7&oВключить звук, проигрываемый при стрижке"}, null),
    shearingSound("shearingSound", "Звук Стрижки", new String[]{"&7&oЗвук, проигрываемый при стрижке предмета"}, FixedMaterial.getMaterial(Arrays.asList("SHEARS"))),
    equipOnInteract("equipOnInteract", "Надевать по Взаимодействию", new String[]{"&7&oНадеть предмет на существо", "&7&oправым кликом (как седло)"}, null),
    oraxen("oraxen", "Oraxen", new String[]{"&7&oПредмет, необходимый для", "&7&oсовершения этого обмена"}, Material.DIAMOND),
    nexo("nexo", "Nexo", new String[]{"&7&oПредмет, необходимый для", "&7&oсовершения этого обмена"}, Material.BRICK_STAIRS),
    papiParser("papiParser", "Обработчик PlaceholderAPI", new String[]{"&7Текст, который нужно использовать вместе со", "&7значением переменной, чтобы она работала", "&7с плейсхолдерами PlaceholderAPI.", "", "&7Подробности смотрите в wiki"}, FixedMaterial.getMaterial(Arrays.asList("LEAD", "LEASH"))),
    teleportRandomly("teleportRandomly", "Эффект Плода Хоруса", new String[]{"&7Дальность случайной телепортации при", "&7поедании расходуемого предмета. Чтобы", "&7отключить, оставьте значение 0."}, Material.ENDER_PEARL),
    onConsumeSound("onConsumeSound", "Звук Употребления", new String[]{"&7Звук, проигрываемый при поедании", "&7расходуемого предмета"}, Material.NOTE_BLOCK),
    clearAllEffects("clearAllEffects", "Снять Все Эффекты", new String[]{"&7Снимает ли расходуемый предмет", "&7текущие эффекты игрока"}, Material.MILK_BUCKET),
    listPotionEffectTypeToRemove("listPotionEffectTypeToRemove", "Эффекты для Снятия", new String[]{"&7Список эффектов, снимаемых при", "&7употреблении"}, Material.GLASS_BOTTLE),

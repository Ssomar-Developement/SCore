...
public enum FeatureSettingsSCoreRU implements FeatureSettingsInterface {
    ...
    dropOptions("dropOptions", "Настройки Выпадения", new String[]{"&7&oНастройки выпадения"}, Material.ANVIL),
    ...
    titleAdjustement("titleAdjustement", "Настройка Заголовка", new String[]{"&7&oНастройка заголовка"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "Параметры Заголовка", new String[]{"&7&oПараметры заголовка"}, Material.ANVIL),
    ...
    cooldownOptions("cooldownOptions", "Настройки Перезарядки", new String[]{"&7&oПерезарядка"}, GUI.CLOCK),
    globalCooldownOptions("globalCooldownOptions", "Глобальные Настройки Перезарядки", new String[]{"&7&oГлобальная перезарядка", "&7&o(Для &eВСЕХ &7&oигроков и существ)"}, GUI.CLOCK),
    ...
    playerCooldownOptions("playerCooldownOptions", "Настройки Перезарядки Игрока", new String[]{"&7&oПерезарядка игрока"}, GUI.CLOCK),
    entityCooldownOptions("entityCooldownOptions", "Настройки Перезарядки Существа", new String[]{"&7&oПерезарядка существа"}, GUI.CLOCK),

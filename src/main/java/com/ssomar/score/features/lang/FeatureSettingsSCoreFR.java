...
public enum FeatureSettingsSCoreFR implements FeatureSettingsInterface {
    ...
    dropFeatures("dropFeatures", "Options de Drop", new String[]{"&7&oLes fonctionnalités de drop"}, Material.ANVIL),
    ...
    potionSettings("potionFeatures", "Paramètres de potion", new String[]{"&7&oLes paramètres de potion"}, FixedMaterial.getBrewingStand()),

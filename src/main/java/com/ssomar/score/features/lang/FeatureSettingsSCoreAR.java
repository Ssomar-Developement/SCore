...
public enum FeatureSettingsSCoreAR implements FeatureSettingsInterface {
    ...
    cooldownOptions("cooldownOptions", "خيارات_فترة_الانتظار", new String[]{"&7&oفترة_الانتظار"}, GUI.CLOCK),
    ...
    dropOptions("dropOptions", "خيارات_الإسقاط", new String[]{"&7&oميزات_الإسقاط"}, Material.ANVIL),
    ...
    entityCooldownOptions("entityCooldownOptions", "خيارات_فترة_انتظار_الكائن", new String[]{"&7&oفترة_انتظار_الكائن"}, GUI.CLOCK),
    ...
    food("food", "ميزات_الطعام", new String[]{"&7&oميزات_الطعام"}, Material.COOKED_BEEF),
    ...
    potionSettings("potionSettings", "إعدادات_الجرعة", new String[]{"&7&oإعدادات_الجرعة"}, FixedMaterial.getBrewingStand()),
    ...
    titleAdjustement("titleAdjustement", "ضبط_العنوان", new String[]{"&7&oضبط_العنوان"}, FixedMaterial.getMaterial(Collections.singletonList("PISTON"))),
    titleOptions("titleOptions", "خيارات_العنوان", new String[]{"&7&oميزات_العنوان"}, Material.ANVIL),
    ...
    globalCooldownOptions("globalCooldownOptions", "خيارات_فترة_الانتظار_العامة", new String[]{"&7&oفترة_الانتظار_العامة", "&7&o(لـ_&eجميع_&7&oاللاعبين_والكائنات)"}, GUI.CLOCK),
    ...
    playerCooldownOptions("playerCooldownOptions", "خيارات_فترة_انتظار_اللاعب", new String[]{"&7&oفترة_انتظار_اللاعب"}, GUI.CLOCK),

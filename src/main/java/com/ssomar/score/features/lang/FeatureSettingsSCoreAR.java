...
public enum FeatureSettingsSCoreAR implements FeatureSettingsInterface {
    ...
    ifUseCooldown("ifUseCooldown", "هل يستخدم فترة التهدئة", new String[]{}, Material.ANVIL),
    input1("input1", "الإدخال 1", new String[]{}, Material.GLASS),
    input2("input2", "الإدخال 2", new String[]{}, Material.GLASS),
    input3("input3", "الإدخال 3", new String[]{}, Material.GLASS),
    input4("input4", "الإدخال 4", new String[]{}, Material.GLASS),
    input5("input5", "الإدخال 5", new String[]{}, Material.GLASS),
    input6("input6", "الإدخال 6", new String[]{}, Material.GLASS),
    input7("input7", "الإدخال 7", new String[]{}, Material.GLASS),
    input8("input8", "الإدخال 8", new String[]{}, Material.GLASS),
    input9("input9", "الإدخال 9", new String[]{}, Material.GLASS),
    ...
    RECIPE("RECIPE", "وصفة", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    RECIPEGROUP("RECIPEGROUP", "مجموعة وصفات", new String[]{}, FixedMaterial.getMaterial(Arrays.asList("CRAFTING_TABLE", "WORKBENCH"))),
    ...
    dropFeatures("dropFeatures", "خيارات_الإسقاط", new String[]{"&7&oميزات_الإسقاط"}, Material.DROPPER),
    ...
    foodFeatures("foodFeatures", "ميزات_الطعام", new String[]{"&7&oميزات_الطعام"}, Material.COOKED_BEEF),

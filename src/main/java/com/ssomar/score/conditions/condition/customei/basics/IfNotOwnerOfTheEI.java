...
public class IfNotOwnerOfTheEI extends CustomEICondition<Boolean, String> {
    ...
    public IfNotOwnerOfTheEI() {
        super(ConditionType.BOOLEAN, "ifNotOwnerOfTheEI", "If not owner of the EI", new String[]{}, false, " &cYou must not be the owner of the item to active the activator: &6%activator% &c!");
    }

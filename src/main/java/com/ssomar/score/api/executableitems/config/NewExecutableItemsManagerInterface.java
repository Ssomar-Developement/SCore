...
public interface NewExecutableItemsManagerInterface {
     ...
     * **/
    Optional<NewExecutableItemInterface> getExecutableItem(String id);

    /** Get an ExecutableItem from its itemStack form
     * @param itemStack The itemStack to get the ExecutableItem from
     * @return The ExecutableItem or an empty optional
     * **/
    Optional<NewExecutableItemInterface> getExecutableItem(ItemStack itemStack);

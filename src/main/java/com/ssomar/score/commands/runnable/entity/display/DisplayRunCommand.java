...
public class DisplayRunCommand extends RunCommand {
    ...
    public DisplayRunCommand(String brutCommand, int delay, ActionInfo aInfo) {
        super(brutCommand, delay, aInfo);
    }

    public DisplayRunCommand(String brutCommand, long runTime, ActionInfo aInfo) {
    ...
    public void runGetManager() {
        this.runCommand(DisplayCommandManager.getInstance());
    }

    @Override
    public void runCommand(SCommandToExec sCommandToExec) {
        DisplaySCommand pCommand = (DisplaySCommand) sCommandToExec.getSCommand();

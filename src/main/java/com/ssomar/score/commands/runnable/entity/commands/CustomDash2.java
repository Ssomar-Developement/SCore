...
/* ANGRYAT {ENTITYUUID} */
public class CustomDash2 extends EntityCommand {
    ...
    public void run(Player p, Entity entity, List<String> args, ActionInfo aInfo) {
        ...
        Vector dashDir = entity.getLocation().toVector().subtract(target.toVector()).normalize().multiply(strength);
        entity.setVelocity(dashDir);
    }

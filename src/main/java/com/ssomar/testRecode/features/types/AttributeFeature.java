...
public class AttributeFeature extends FeatureAbstract<Optional<Attribute>, AttributeFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public void extractInfoFromParentEditor(NewGUIManager manager, Player player) {
        value =  Optional.of(getAttribute((GUI) manager.getCache().get(player)));
    }

    @Override
    public AttributeFeature clone() {
        AttributeFeature clone = new AttributeFeature(getParent(), this.getName(), defaultValue, getEditorName(), getEditorDescription(), getEditorMaterial(), isRequirePremium());
        clone.value = value;
        return clone;
    }

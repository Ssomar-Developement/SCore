 ...
 */
public class CustomBlockDataPlaceEvent extends CustomBlockDataEvent {

    public CustomBlockDataPlaceEvent(@NotNull Plugin plugin, @NotNull Block block, @Nullable Event bukkitEvent) {

...
import com.ssomar.customblockdata.CustomBlockData;
...
public class CustomBlockDataEvent extends Event implements Cancellable {
    ...
    public enum Reason {
         ...
         * @see BlockFadeEvent
         */
        FALLING_BLOCK_START_FALLING(FallingBlockStartFallingEvent.class),

        FALLING_BLOCK_LAND(FallingBlockLandEvent.class),

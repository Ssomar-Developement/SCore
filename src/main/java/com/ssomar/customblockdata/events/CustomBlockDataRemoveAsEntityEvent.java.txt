 ...
 */
public class CustomBlockDataRemoveAsEntityEvent extends CustomBlockDataAsEntityEvent {

    public CustomBlockDataRemoveAsEntityEvent(@NotNull Plugin plugin, @NotNull Entity entity, @Nullable Event bukkitEvent) {
        super(plugin, entity, bukkitEvent);
    }
